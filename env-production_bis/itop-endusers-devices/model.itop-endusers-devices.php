...
/**
 * Classes and menus for itop-endusers-devices (version 3.0.1)
 *
...
class PC extends ConnectableCI
{
	public static function Init()
	{
		$aParams = array(			'category' => 'bizmodel,searchable',
			...
			'db_key_field' => 'id',
			'db_finalclass_field' => '',
			'style' =>  new ormStyle(null, null, null, null, null, 'itop-endusers-devices/../../images/icons/icons8-laptop.svg'),);
...
class Printer extends ConnectableCI
{
	public static function Init()
	{
		$aParams = array(			'category' => 'bizmodel,searchable',
			...
			'db_key_field' => 'id',
			'db_finalclass_field' => '',
			'style' =>  new ormStyle(null, null, null, null, null, 'itop-endusers-devices/../../images/icons/icons8-print.svg'),);
		MetaModel::Init_Params($aParams);
		MetaModel::Init_InheritAttributes();
...
abstract class TelephonyCI extends PhysicalDevice
{
	public static function Init()
	{
		$aParams = array(			'category' => 'bizmodel,searchable',
			...
			'db_key_field' => 'id',
			'db_finalclass_field' => '',
			'style' =>  new ormStyle(null, null, null, null, null, 'itop-endusers-devices/../../images/icons/icons8-phone.svg'),);
		MetaModel::Init_Params($aParams);
		MetaModel::Init_InheritAttributes();
...
class Phone extends TelephonyCI
{
	public static function Init()
	{
		$aParams = array(			'category' => 'bizmodel,searchable',
			...
			'db_key_field' => 'id',
			'db_finalclass_field' => '',
			'style' =>  new ormStyle(null, null, null, null, null, 'itop-endusers-devices/../../images/icons/icons8-telephone.svg'),);
		MetaModel::Init_Params($aParams);
		MetaModel::Init_InheritAttributes();
...
class MobilePhone extends TelephonyCI
{
	public static function Init()
	{
		$aParams = array(			'category' => 'bizmodel,searchable',
			...
			'db_key_field' => 'id',
			'db_finalclass_field' => '',
			'style' =>  new ormStyle(null, null, null, null, null, 'itop-endusers-devices/../../images/icons/icons8-mobile.svg'),);
		MetaModel::Init_Params($aParams);
		MetaModel::Init_InheritAttributes();
...
class IPPhone extends TelephonyCI
{
	public static function Init()
	{
		$aParams = array(			'category' => 'bizmodel,searchable',
			...
			'db_key_field' => 'id',
			'db_finalclass_field' => '',
			'style' =>  new ormStyle(null, null, null, null, null, 'itop-endusers-devices/../../images/icons/icons8-office-phone.svg'),);
		MetaModel::Init_Params($aParams);
		MetaModel::Init_InheritAttributes();
...
class Tablet extends PhysicalDevice
{
	public static function Init()
	{
		$aParams = array(			'category' => 'bizmodel,searchable',
			...
			'db_key_field' => 'id',
			'db_finalclass_field' => '',
			'style' =>  new ormStyle(null, null, null, null, null, 'itop-endusers-devices/../../images/icons/icons8-smartphone-tablet.svg'),);
		MetaModel::Init_Params($aParams);
		MetaModel::Init_InheritAttributes();
...
class Peripheral extends PhysicalDevice
{
	public static function Init()
	{
		$aParams = array(			'category' => 'bizmodel,searchable',
			...
			'db_key_field' => 'id',
			'db_finalclass_field' => '',
			'style' =>  new ormStyle(null, null, null, null, null, 'itop-endusers-devices/../../images/icons/icons8-electronics.svg'),);
		MetaModel::Init_Params($aParams);
		MetaModel::Init_InheritAttributes();
